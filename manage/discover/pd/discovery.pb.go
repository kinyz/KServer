...
type Discovery struct {
	...
	Id       uint32 `protobuf:"varint,1,opt,name=Id,proto3" json:"Id,omitempty"`            // 总线程ID
	...
	Host     string `protobuf:"bytes,4,opt,name=Host,proto3" json:"Host,omitempty"`         // 服务器host
	Port     string `protobuf:"bytes,5,opt,name=Port,proto3" json:"Port,omitempty"`         // 服务器port
	Type     string `protobuf:"bytes,6,opt,name=Type,proto3" json:"Type,omitempty"`         // 服务类型
	State    uint32 `protobuf:"varint,7,opt,name=State,proto3" json:"State,omitempty"`      // 服务状态
}
...
func (x *Discovery) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *Discovery) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *Discovery) GetState() uint32 {
	if x != nil {
		return x.State
	}
	return 0
...
var file_discovery_proto_rawDesc = []byte{
	...
	,
}
